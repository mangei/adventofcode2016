...
# python 15_1.py < input_15.txt
# correct answer: 121834
...
for line in sys.stdin:
    ...
    discs.append((discPositions, discInitialPosition))

disc_indices = range(len(discs))
t = 0
while True:
    valid = True
    for i in disc_indices:
        (discPositions, discInitialPosition) = discs[i]
        currentPosition = (discInitialPosition + t + i) % discPositions
